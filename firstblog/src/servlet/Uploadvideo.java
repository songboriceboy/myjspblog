...
//   图片上传路径
   String uploadPath =request.getSession().getServletContext().getRealPath("/")+"upload/videos/";
//   图片临时上传路径
   String tempPath = request.getSession().getServletContext().getRealPath("/")+"upload/vodeos/temp/";
//   图片网络相对路径
...
//   获得文件名，这个文件名是用户上传时用户的绝对路径：
   ...
   if(sourcefileName!=null&&sourcefileName.endsWith(".mp4")) {
