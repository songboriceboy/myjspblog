...
function reset_form()
{
    ...
    <script type="text/javascript">
         function check(form) {
          ...
          if(form.catename.value==''||form.catename.value.length>20) {
                alert("请输入合适类别!");
                form.title.focus();
                return false;
           }
...
%>
   ...
   <div style="text-align:center">		
            ...
            catedal ctdal=new catedal();
                   ...
                   ResultSet rs= ctdal.searchcatebyid(cateid);//执行查询
                   while(rs.next()){
%> 
    
    <form action="UpdateCate" method="post">
    <input type="hidden" name="cateid" value="<%=cateid%>" >   
    <input type="text" name="catename" value="<%=rs.getString("cName")%>" >  
