...
self.location="photos.jsp";
	...
	<%
	        ...
	        String filepath =request.getSession().getServletContext().getRealPath("/")+"upload/photos/";
         ...
         for (int i = 0; i < fa.length; i++) {
            ...
            <a href=<%=fp%> target="_blank">
             ...
             &nbsp &nbsp &nbsp
          <a href="DeletePhoto?path=<%=file%>" target="_blank">
               <span>删除</span>               
            </a>
           &nbsp &nbsp &nbsp
