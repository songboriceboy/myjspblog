...
ResultSet liuyanrs=lydal.selectliuyanpage(pageSize, pageNow);


while(liuyanrs.next()){

String lcontent=liuyanrs.getString("lContent");
if(lcontent.length()>10){
lcontent=lcontent.substring(0, 10);
}
%>
				...
				<tr> 
    				...
    				<td><%=liuyanrs.getString("lUser")%></td> 
    				<td><%=liuyanrs.getString("lDate")%></td> 
    				<td><%=lcontent%></td>
   				 	<td><a href="liuyanreply.jsp?id=<%=liuyanrs.getInt("lId")%>"><input type="image" src="images/icn_edit.png" title="回复">  </a> <a href="DeleteLiuyan?id=<%=liuyanrs.getInt("lId")%>"><input type="image" src="images/icn_trash.png" title="Trash"></a>
...
%>
<a href = "liuyanlist.jsp?pageNow=1" >首页</a>  &nbsp &nbsp &nbsp &nbsp &nbsp 
<a href = "liuyanlist.jsp?pageNow=<%=pageNow-1%>" >上一页</a>  &nbsp &nbsp &nbsp 
<%}%>    
...
%>
<a href = "liuyanlist.jsp?pageNow=<%=pageNow+1%>" >下一页</a>   &nbsp &nbsp &nbsp 
<a href = "liuyanlist.jsp?pageNow=<%=pageCount%>" >尾页</a>   &nbsp &nbsp &nbsp 
<%}%>
